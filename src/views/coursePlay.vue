        ...
        <el-tabs tab-position="right">
          <el-tab-pane>
            ...
            <div class="course-container">
              ...
              <div class="courseDesc">{{ chapterInfo.chapterName }}</div>
              <div class="courseImg">
                <img :src="chapterInfo.chapterLitpic" alt="" />
              </div>
              <div class="teacherRecommend" v-if="true">讲师介绍</div>
              ...
              <div class="teacherReacher" v-if="true">56565656</div>
            </div>
          </el-tab-pane>
          <el-tab-pane>
            <template #label>
...
<script>
import { player } from '../api/courseManagement';
import { ArrowLeftBold, Document } from '@element-plus/icons-vue';
import { useRoute } from 'vue-router';
import { onBeforeMount, ref, reactive } from 'vue';
import 'vue3-video-play/dist/style.css';
import vue3VideoPlay from 'vue3-video-play';
import mp4 from '../assets/open.mp4';
import { recordHistory, getLastHistoryByChapterId } from '../api/history';
